...
Ten vyhodnocuje kvalitu signálu pomocí kombinace pravidel založených na detekci pulzů a následného porovnání morfologie jednotlivých pulzních vln s průměrnou šablonou. % Tato metoda hodnotí signály na základě spektrální dominance, pravidelnosti inter-beat intervalů a morfologické stability pulzních vln.
