...
Výsledky výpočtů jsou zobrazeny na Obr.~\ref{fig:thresholds_peaks_clean} a~\ref{fig:thresholds_peaks}.
...
První práh je vykreslen na Obr.~\ref{fig:thresholds_peaks_clean} a~\ref{fig:thresholds_peaks} společně s klouzavými průměry a umocněným signálem.
