...
Tato knihovna reaguje na \uv{krizi reprodukovatelnosti} v psychologii a neurovědách, což je problém, kdy vědecké studie nelze opakovaně potvrdit kvůli nedostatečné nedostupnosti dat a kódu.
...
Pro vypočítání konkrétních velikostí oken bylo provedeno \uv{brute force} hledání vhodných parametrů tak, že se vyzkoušely různé kombinace délek těchto a dalších a konstant.
...
Konstanta \(\beta\) je jedním z~parametrů, které se nastavují pomocí \uv{brute force} hledání~\cite{Elgendi2013}.

První práh je vykreslen na obrázcích~\ref{fig:thresholds_peaks_clean} a~\ref{fig:thresholds_peaks} společně s klouzavými průměry a umocněným signálem.
