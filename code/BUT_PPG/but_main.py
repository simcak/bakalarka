...
def but_ppg_main(method: str, show=False, first=False):
	...
	for i in range(G.BUT_DATA_LEN):
		...
		# if method == 'my' and show and hr_info['Diff HR'] > 20 and but_signal_info['Ref_Quality'] == 1:
		if method == 'my' and show:
			but_show.test_hub(preprocess.standardize_normalize_signal(but_signal_info['PPG_Signal']), filtered_ppg_signal, detected_peaks, hr_info, but_signal_info['ID'], i)
