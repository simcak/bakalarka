...
def main_calculation(capnobase_file, show_plots=False):
	...
	print(f'File: {capnobase_file} | Ref HR: {round(ref_hr, 3)} bpm | Our HR: {round(our_hr, 3)} bpm\
...
def main():
	...
	print('\n')
	file_num = 34
	ref_hr, our_hr = main_calculation(capnobase_files[file_num], show_plots=True)
